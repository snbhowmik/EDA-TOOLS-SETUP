...
# ─────────────────────────────────────────────────────────────────────────────
echo -e "\n${GREEN}══════════════════════════════════════════${NC}"
echo -e "${GREEN}  PRE-INSTALL CONFIGURATION${NC}"
echo -e "${GREEN}══════════════════════════════════════════${NC}\n"
...
echo -e "\n  ${YELLOW}Machine : ${HOSTNAME}${NC}"
echo -e "  ${YELLOW}Admin   : ${SYSADMIN_USER} (pre-existing)${NC}"
echo -e "  ${YELLOW}Student : ${STUDENT_USER} (will be created)${NC}\n"
